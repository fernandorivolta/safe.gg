...
$(document).ready(function(){
    if(search){
      ...
      $.ajax({
        type : 'GET',
        url : 'http://localhost/safe.gg/controller/searchProPlayer.php?search=' + search,
        dataType : 'json',
        async: false,
